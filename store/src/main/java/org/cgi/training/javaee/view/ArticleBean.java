package org.cgi.training.javaee.view;
...
public class ArticleBean implements Serializable
{
   ...
   @PersistenceContext(unitName = "storePersistenceUnit", type = PersistenceContextType.EXTENDED)
   ...
   public Converter getConverter()
   {
      ...
      final ArticleBean ejbProxy = this.sessionContext.getBusinessObject(ArticleBean.class);
